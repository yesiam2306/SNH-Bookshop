...
/**
 * la funzione controlla se il titolo è valido e se è già stato utilizzato dallo stesso autore.
 * possono esserci opere omonime di autori diversi, ma non dello stesso autore.
 */
...
/**
 * per evitare che un utente possa caricare più volte lo stesso file con nomi diversi.
 */
...
function move_file($tmp_path, $dest)
{
    ...
    {
        log_error("UPLOAD - Upload directory is not writable");
        return false;
    }
...
function getPDF($mysqli, $novel_id)
{
    return \DBM\getNovelPDFById($mysqli, $novel_id);
}
