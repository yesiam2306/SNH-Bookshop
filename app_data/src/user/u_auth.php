...
/**
 * commentata perché non la volevo togliere. sarebbe la vecchia funzione per far diventare premium un utente, prima che capissi che
 * era richiesto che fosse un operazione manuale da parte dell'amministratore.
 */
